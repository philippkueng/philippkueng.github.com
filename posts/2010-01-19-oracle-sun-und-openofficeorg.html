...
<p>Wer an der ETH Zürich studiert muss sich wärend seiner Zeit Punkte in Geisteswissenschaftlichen Fächern
    ...
    hoffentlich nach dem lesen <a
        href="/files/2010/1/Digitale+Nachhaltigkeit+-+Oracle+Sun+und+Open+Office_final.pdf">meiner Arbeit</a> erübrigen
...
<div style="width:666px;text-align:left" id="__ss_2928863"><object style="margin:0px" width="666" height="556">
        <param name="movie"
            value="http://static.slidesharecdn.com/swf/ssplayer2.swf?doc=oraclesunundopenoffice-org-100116093101-phpapp02&rel=0&stripped_title=oracle-sun-und-openofficeorg" />
        <param name="allowFullScreen" value="true" />
        <param name="allowScriptAccess" value="always" /><embed
            src="http://static.slidesharecdn.com/swf/ssplayer2.swf?doc=oraclesunundopenoffice-org-100116093101-phpapp02&rel=0&stripped_title=oracle-sun-und-openofficeorg"
...
<p>Das Highlight war jedoch, als eine Woche später <a
        href="http://en.wikipedia.org/wiki/Simon_Phipps_(programmer)">Simon Phipps</a> von der OpenSource Abteilung von
...
<img src="/images/2010/1/Simon-Phipps.jpg" alt="Simon Phipps - Sun Microsystems" />
<p><strong>Korrektur</strong><br />Wie Stephan in dem Forum Eintrag <a
        href="http://de.openoffice.info/viewtopic.php?f=16&t=34701">'Zukunft von OpenOffice nach Sun-Übernahme'</a>
