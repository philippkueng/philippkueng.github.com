...
<p>Auch das Fernsehen von <a href="http://www.telezueri.ch">Tele Züri</a> war mit <a
        href="http://www.telezueri.ch/index.php?id=60814">Benno Kaelin</a> anwesend und berichtete in den
    Abendnachrichten davon.</p>
<object width="666" height="401">
    <param name="movie" value="http://www.youtube.com/v/2t6TAJ0YxGo&hl=en_US&fs=1&">
    </param>
    <param name="allowFullScreen" value="true">
    </param>
    <param name="allowscriptaccess" value="always">
    </param><embed src="http://www.youtube.com/v/2t6TAJ0YxGo&hl=en_US&fs=1&" type="application/x-shockwave-flash"
