...
<p>If you&rsquo;ve installed Visual Studio 2008 on an x64 Windows Computer you may getting into trouble trying to
    ...
    file. (shown below)</p>
<p><img title="vs08sp1_installation_log" src="/images/vs08sp1_installation_log_thumb.png"
        alt="vs08sp1_installation_log" /></p>
<p>In there select the link (marked yellow).</p>
<p><img title="vs08sp1_installation_error_log" src="/images/vs08sp1_installation_error_log_thumb.png"
