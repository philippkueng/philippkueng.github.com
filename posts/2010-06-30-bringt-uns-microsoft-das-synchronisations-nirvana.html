...
Comments: true
Tags: untagged
<img title="Live_Sync_Nirvana" alt="Live_Sync_Nirvana" src="/images/Live_Sync_Nirvana.png" />
<p>Schon seit einer Weile wird in Szene-Blogs immer wieder von der neuen <a
        href="http://windowslivepreview.com/essentials">“Wave 4”</a> der Windows Live Essentials geschrieben, dabei
...
<p>Aufgrund der bevorstehenden finalen Version, möchte ich an dieser Stelle kurz die Vor- und Nachteile von <a
        href="http://windowslivepreview.com/essentials/sync/">Live Sync</a> aufzeigen, und insbesondere mit der
    möglichen Konkurrenz (<a href="https://www.dropbox.com/referrals/NTEwMzUxOTk">Dropbox</a> und <a
        href="http://www.wuala.com/referral/AN647NN4JHN3PBAGNGHC">Wuala</a>) vergleichen. Es ist mir dabei klar, dass
...
<p><strong>Kein Live Sync auf Linux</strong> <br />Anders als Wuala, wo auf Java gesetzt wird und Dropbox die einen
    nativen Client haben, funktioniert Live Sync nicht auf Linux obwohl es dank dem <a
        href="http://www.mono-project.com">Mono Projekt</a> teilweise möglich wäre .NET Applikationen unter Linux zu
    betreiben.</p>
...
<p><strong>Synchronisation von Programm Einstellungen</strong> <br />Früher war <a
        href="http://delicious.com/">deli.cio.us</a> das Mass aller Dinge wenn es um Lesezeichen ging, egal an welchem
...
<p><strong>Remote Desktop <br /></strong>Als weiteres Killer Feature bekommt Live Sync den aus <a
        href="http://www.mesh.com">Mesh</a> bekannten Remote Desktop. Dies ist vorallem praktisch um dem Kunden übers
...
<p><strong>Fazit</strong> <br />Microsoft hat sicherlich hie und da noch etliche Schachstellen auszubügeln um im Markt
    ...
    beispielsweise, dass per Live Sync in die Cloud hochgeladene Dokumente auch mit den <a
        href="http://philippkueng.ch/post/Docscom-der-Google-Docs-Killer.aspx">Office Web Apps</a> per Browser editiert
